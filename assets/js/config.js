...
window.SITE = {
  ...
  // The VM monogram (one SVG, colored per page by CSS)
  monogram: 'assets/img/vm-monogram.svg',
  ...
  /* One entry per page. The ORDER here is the order of the navigation menu.
       ...
       favicon - PNG tab icon used by browsers that can't show SVG icons (Safari)
       emoji   - shown in the visitor counter badge
       nav     - false keeps a page out of the menu (e.g. the Paris guide)          */
  pages: [
    { key: 'home',      label: 'Home',        url: 'index.html',      color: '#ae2c78', light: '#c85a9a', dark: '#7d1f56', emoji: '🎨', favicon: 'assets/img/favicon-home.png' },
    { key: 'exp',       label: 'Experience',  url: 'work.html',       color: '#1f5b46', light: '#3a6b52', dark: '#143d2f', emoji: '🌱', favicon: 'assets/img/favicon-exp.png' },
    { key: 'story',     label: 'Writing',     url: 'writing.html',    color: '#2b48a0', light: '#5d6a8a', dark: '#1f2a48', emoji: '✍️', favicon: 'assets/img/favicon-story.png' },
    { key: 'portfolio', label: 'Portfolio',   url: 'portfolio.html',  color: '#d9552d', light: '#e07a5a', dark: '#9c4f2b', emoji: '🦋', favicon: 'assets/img/favicon-portfolio.png' },
    { key: 'world',     label: 'Background',  url: 'background.html', color: '#3a6b52', light: '#4aa876', dark: '#24483a', emoji: '🌎', favicon: 'assets/img/favicon-world.png' },
    { key: 'contact',   label: 'Connect',     url: 'contact.html',    color: '#d9574c', light: '#e88a80', dark: '#b52f2e', emoji: '🪩', favicon: 'assets/img/favicon-contact.png' },
    { key: 'paris',     label: 'Paris Guide', url: 'paris.html',      color: '#1f2a48', light: '#5d6a8a', dark: '#141b30', emoji: '🥐', favicon: 'assets/img/favicon-paris.png', nav: false },
  ],
};
